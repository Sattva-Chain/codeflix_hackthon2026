    ...
    <div className={`relative min-h-screen overflow-hidden bg-black w-full ${className}`}>
      ...
      <style>{`
        ...
        @keyframes aurora3 {
          ...
          100% { transform: translateX(-20px) translateY(50px) rotate(450deg) scale(1); }
        }
  ...
  return (
    <AuroraBackground>
      <div className="flex flex-col items-center justify-center min-h-screen px-8 text-center">
        <h1 className="text-6xl font-bold text-white mb-4 tracking-tight">SecureScan</h1>
        <p className="text-xl text-gray-300 mb-8 max-w-md">
          Protect your repositories with automated secret detection and remediation.
        </p>
